  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to QA Restaurant Booking Engine, your digital partner in seamless table reservations and efficient menu management. Transforming restaurant management for enhanced customer experiences."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to QA Restaurant Booking Engine, your digital partner in seamless table reservations and efficient menu management. Transforming restaurant management for enhanced customer experiences.`}
            </Text>
            <Box
